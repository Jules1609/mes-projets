...
#def _plot_uncontroled_solution(x_plot, y_plot, x, y, u, chi):
    ...
    myimshow(numpy.abs(u), title='$\operatorname{Abs}(u_{0})$ in $\Omega$', colorbar='colorbar', cmap='jet', vmin=-1, vmax=1, filename='fig_u0_abs.jpg')
...
#def _plot_controled_solution(x_plot, y_plot, x, y, u, chi):
    ...
    myimshow(numpy.abs(u), title='$\operatorname{Abs}(u_{n})$ in $\Omega$', colorbar='colorbar', cmap='jet', vmin=-1, vmax=1, filename='fig_un_abs.jpg')
